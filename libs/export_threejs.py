...
BLENDER_TEXTURE_PATH = "../../blendertextures/"
...
def extract_material_data(m, option_colors):
    ...
    if textures['diffuse']:
        material['mapDiffuse'] = BLENDER_TEXTURE_PATH + textures['diffuse']['texture'].image.name

    if textures['light']:
        material['mapLight'] = BLENDER_TEXTURE_PATH + textures['light']['texture'].image.name

    if textures['specular']:
        material['mapSpecular'] = BLENDER_TEXTURE_PATH + textures['specular']['texture'].image.name

    if textures['normal']:
        material['mapNormal'] = BLENDER_TEXTURE_PATH + textures['normal']['texture'].image.name
        if textures['normal']['slot'].use_map_normal:
            material['mapNormalFactor'] = textures['normal']['slot'].normal_factor

    if textures['bump']:
        material['mapBump'] = BLENDER_TEXTURE_PATH + textures['bump']['texture'].image.name
